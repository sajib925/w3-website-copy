...
const CUserInput = () => {
    ...
    return(
        <div  className="">
            <h2 className="H3 md-space-bottom">আজকে আমরা C প্রোগ্রামিংয়ের অন্যতম গুরুত্বপূর্ণ একটি ইউজার ইনপুট সম্পর্কে জানবো।</h2>
            ...
            <div className="navigate-buttons-style">
                <ButtonSecondary btnLink={"/c_strings"} btnText={"❮ পূর্ববর্তী অধ্যায়"}/>
                <ButtonSecondary btnLink={"/c_memory_address"} btnText={"পরবর্তী অধ্যায় ❯"}/>
            </div>
        </div>
    )
}

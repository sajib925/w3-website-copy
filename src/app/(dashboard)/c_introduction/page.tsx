...
const CIntroduction = () => {
    return(
        <div>
            <h2 className="H3 lg-space-bottom">C ল্যাংগুয়েজের পরিচিতি।</h2>
            <div className="box-style-primary">
                <h3 className="H4">C আসলে কি??</h3>
            ...
            <div className="pt-[22px] pb-[32px]">
                <h3 className="H4">এত প্রোগ্রামিং ল্যাংগুয়েজ থাকতে আমি কেন C শিখব??</h3>
            ...
            <div className="box-style-primary">
                <h3 className="H4">IDE ইন্সটল করুন</h3>
                <ul className="list-items-style">
